...
if (!$conn) {
   ...
   <div class="header"><b>FEEDBACK FORM</b></div>
   
   <table cellspacing="0">
     
      <tr>
      	<td>1</td>
         <td width="400"><b>Teacher’s punctuality to the class</b></td>
         <td colspan="5" style="vertical-align:top;"><div class="toggle">
            ...
            <input type="radio" id="a5" name="q1" value="2" required />
            <label for="a5">BelowSatisfactory</label></td>
      </tr>
      <tr>
      	<td>2</td>
         <td><b>Explanation of subject content with clarity</b></td>
   ...
   <tr><td>3</td>
         <td><b>Ability to relate theory with practical applications</b></td>
         <td colspan="5" style="text-align: center;"><div class="toggle">
...
<tr><td>5</td>
         <td><b>Maintaining discipline during class</b></td>
         <td colspan="5" style="text-align: center;"><div class="toggle">
...
<tr>
	<td>6</td>
         <td><b>Inviting opinion and questions on subject matter from students</b></td>
         <td colspan="5" style="text-align: center;"><div class="toggle">
            <input type="radio" id="a26" name="q6" value="10" required />
            <label for="a26">Excellent</label>
         <input type="radio" id="a27" name="q6" value="8" required />
            <label for="a27">Very Good</label>
         <input type="radio" id="a28" name="q6" value="6" required />
            <label for="a28" style=" font-size: 16px;">Good</label>
         <input type="radio" id="a29" name="q6" value="4" required />
            <label for="a29">Satisfactory</label>
         <input type="radio" id="a30" name="q6" value="2" required />
            <label for="a30">BelowSatisfactory</label></td></div>
      </tr>

 <tr><td>7</td>
         <td><b>Encouraging students to give presentation on course related topics </b></td>
         <td colspan="5" style="text-align: center;"><div class="toggle">
            <input type="radio" id="a31" name="q7" value="10" required />
            <label for="a31">Excellent</label>
         <input type="radio" id="a32" name="q7" value="8" required />
            <label for="a32">Very Good</label>
         <input type="radio" id="a33" name="q7" value="6" required />
            <label for="a33">Good</label>
         <input type="radio" id="a34" name="q7" value="4" required />
            <label for="a34">Satisfactory</label>
         <input type="radio" id="a35" name="q7" value="2" required />
            <label for="a35">BelowSatisfactory</label></td></div>
      </tr>
       <tr><td>8</td>
         <td><b>Providing reference for additional course material </b></td>
         <td colspan="5" style="text-align: center;"><div class="toggle">
            <input type="radio" id="a36" name="q8" value="10" required />
            <label for="a36">Excellent</label>
         <input type="radio" id="a37" name="q8" value="8" required />
            <label for="a37">Very Good</label>
         <input type="radio" id="a38" name="q8" value="6" required />
            <label for="a38">Good</label>
         <input type="radio" id="a39" name="q8" value="4" required />
            <label for="a39">Satisfactory</label>
         <input type="radio" id="a40" name="q8" value="2" required />
            <label for="a40">BelowSatisfactory</label></td></div>
      </tr>
      
       <tr><td>9</td>
         <td><b>Giving opportunity for clarification of doubts</b></td>
         <td colspan="5" style="text-align: center;"><div class="toggle">
            <input type="radio" id="a41" name="q9" value="10" required />
            <label for="a41">Excellent</label>
         <input type="radio" id="a42" name="q9" value="8" required />
            <label for="a42">Very Good</label>
         <input type="radio" id="a43" name="q9" value="6" required />
            <label for="a43">Good</label>
         <input type="radio" id="a44" name="q9" value="4" required />
            <label for="a44">Satisfactory</label>
         <input type="radio" id="a45" name="q9" value="2" required />
            <label for="a45">BelowSatisfactory</label></td></div>
      </tr>
      
       <tr><td>10</td>
         <td><b>Fairness and impartiality towards students</b></td>
         <td colspan="5" style="text-align: center;"><div class="toggle">
            <input type="radio" id="a46" name="q10" value="10" required />
            <label for="a46">Excellent</label>
        <input type="radio" id="a47" name="q10" value="8" required />
            <label for="a47">Very Good</label>
        <input type="radio" id="a48" name="q10" value="6" required />
            <label for="a48" style=" font-size: 16px;">Good</label>
        <input type="radio" id="a49" name="q10" value="4" required />
            <label for="a49">Satisfactory</label>
        <input type="radio" id="a50" name="q10" value="2" required />
            <label for="a50">BelowSatisfactory</label></td></div>
      </tr>
